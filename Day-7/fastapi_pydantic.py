# -*- coding: utf-8 -*-
"""fastapi_pydantic.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WOmsQEPi8xyOG_z5-pypbCFqiqcoMy5U
"""

!pip install fastapi uvicorn "pydantic[email]" httpx pytest -q
...
with open("routers/orders.py", "w") as f:
    f.write("""
from fastapi import APIRouter
...
# Task 1-Easy: Order filtering by status
# Add a query parameter to GET /orders/ to filter by status:
...
@router.get(
    "/",
    response_model=List[OrderResponse],
    summary="List all orders with pagination and sorting",
)
def list_orders(
